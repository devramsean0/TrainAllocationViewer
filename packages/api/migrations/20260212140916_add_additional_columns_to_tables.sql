...
ALTER TABLE allocations ADD COLUMN sequence_number BIGINT;
ALTER TABLE allocations ADD COLUMN resource_group_position BIGINT;
ALTER TABLE allocations ADD COLUMN diagram_no TEXT;
ALTER TABLE allocations ADD COLUMN origin_miles BIGINT;
ALTER TABLE allocations ADD COLUMN destination_miles BIGINT;
...
ALTER TABLE vehicles ADD COLUMN resource_position BIGINT;
